...
import { Injectable, Component, NgModule, EventEmitter, HostBinding, Output, ViewChild, Input, ViewEncapsulation, Directive, ContentChildren, forwardRef, ChangeDetectionStrategy, HostListener } from '@angular/core';

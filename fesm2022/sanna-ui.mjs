...
class SaCalendarComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "18.2.13", type: SaCalendarComponent, selector: "sa-calendar", inputs: { size: "size", status: "status", label: "label", noLabel: "noLabel", placeholder: "placeholder", helperText: "helperText", errorText: "errorText", required: "required", readonly: "readonly", disabled: "disabled", minDate: "minDate", maxDate: "maxDate", id: "id", name: "name", locale: "locale", colors: "colors", config: "config", validation: "validation", events: "events", inline: "inline", showInput: "showInput" }, outputs: { dateSelect: "dateSelect", viewChange: "viewChange", monthChange: "monthChange", yearChange: "yearChange", focus: "focus", blur: "blur" }, host: { listeners: { "document:click": "onDocumentClick($event)" } }, providers: [
        ...
        ], usesOnChanges: true, ngImport: i0, template: "<div class=\"sa-calendar-container\">\r\n  <!-- Input field (if not inline) -->\r\n  <div *ngIf=\"!inline\" class=\"calendar-input-container\">\r\n    <label *ngIf=\"shouldShowLabel\" [for]=\"calendarId\" [class]=\"labelClasses\">\r\n      {{ label }}\r\n      <span *ngIf=\"required && label\" class=\"text-danger\">*</span>\r\n    </label>\r\n\r\n    <div class=\"position-relative\">\r\n      <input\r\n        [id]=\"calendarId\"\r\n        [name]=\"name\"\r\n        [class]=\"inputClasses\"\r\n        type=\"text\"\r\n        [value]=\"inputValue\"\r\n        [placeholder]=\"placeholder\"\r\n        [required]=\"required\"\r\n        readonly=\"true\"\r\n        [disabled]=\"disabled\"\r\n        spellcheck=\"false\"\r\n        autocomplete=\"off\"\r\n        (click)=\"onInputClick()\"\r\n        (focus)=\"onInputFocus($event)\"\r\n        (blur)=\"onInputBlur($event)\"\r\n      />\r\n      \r\n      <!-- Clear icon (X) cuando hay valor -->\r\n      <div \r\n        *ngIf=\"inputValue && !disabled\"\r\n        class=\"clear-icon\" \r\n        (click)=\"onClearValue($event)\"\r\n        title=\"Limpiar fecha\">\r\n        <svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\">\r\n          <line x1=\"18\" y1=\"6\" x2=\"6\" y2=\"18\"></line>\r\n          <line x1=\"6\" y1=\"6\" x2=\"18\" y2=\"18\"></line>\r\n        </svg>\r\n      </div>\r\n\r\n      <!-- Calendar icon (cuando no hay valor o est\u00E1 deshabilitado) -->\r\n      <div \r\n        *ngIf=\"!inputValue || disabled\"\r\n        class=\"calendar-icon\" \r\n        [class.disabled]=\"disabled || readonly\"\r\n        (click)=\"onInputClick()\">\r\n        <svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\">\r\n          <rect x=\"3\" y=\"4\" width=\"18\" height=\"18\" rx=\"2\" ry=\"2\"></rect>\r\n          <line x1=\"16\" y1=\"2\" x2=\"16\" y2=\"6\"></line>\r\n          <line x1=\"8\" y1=\"2\" x2=\"8\" y2=\"6\"></line>\r\n          <line x1=\"3\" y1=\"10\" x2=\"21\" y2=\"10\"></line>\r\n        </svg>\r\n      </div>\r\n    </div>\r\n\r\n    <div *ngIf=\"helperText && !errorText\" class=\"form-text\">{{ helperText }}</div>\r\n    <div *ngIf=\"errorText\" class=\"invalid-feedback d-block\">{{ errorText }}</div>\r\n  </div>\r\n\r\n  <!-- Calendar popup/inline -->\r\n  <div \r\n    class=\"calendar-popup\" \r\n    [class.inline]=\"inline\"\r\n    [class.open]=\"isOpen\"\r\n    [style.--primary-color]=\"mergedColors.primary\"\r\n    [style.--secondary-color]=\"mergedColors.secondary\"\r\n    [style.--success-color]=\"mergedColors.success\"\r\n    [style.--error-color]=\"mergedColors.error\"\r\n    [style.--background-color]=\"mergedColors.background\"\r\n    [style.--surface-color]=\"mergedColors.surface\"\r\n    [style.--border-color]=\"mergedColors.border\"\r\n    [style.--disabled-color]=\"mergedColors.disabled\"\r\n    [style.--hover-color]=\"mergedColors.hover\"\r\n    [style.--weekday-header-bg]=\"mergedColors.weekdayHeaderBg\"\r\n    [style.--weekday-header-color]=\"mergedColors.weekdayHeaderColor\"\r\n    *ngIf=\"inline || isOpen\">\r\n    \r\n    <!-- Calendar header -->\r\n    <div class=\"calendar-header\" *ngIf=\"mergedConfig.showHeader\">\r\n      <!-- Navigation -->\r\n      <div class=\"calendar-navigation\" *ngIf=\"mergedConfig.showNavigation\">\r\n        <button \r\n          type=\"button\" \r\n          class=\"nav-button prev\" \r\n          (click)=\"navigatePrevious()\"\r\n          [disabled]=\"disabled || !canNavigateToPreviousMonth() && currentView === 'day' || !canNavigateToPreviousYear() && currentView === 'month'\">\r\n          <svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\">\r\n            <polyline points=\"15,18 9,12 15,6\"></polyline>\r\n          </svg>\r\n        </button>\r\n\r\n        <div class=\"header-title-container\">\r\n          <button \r\n            type=\"button\" \r\n            class=\"header-title\"\r\n            (click)=\"currentView === 'day' ? setView('month') : currentView === 'month' ? setView('year') : null\"\r\n            [disabled]=\"disabled\">\r\n            {{ getHeaderTitle() }}\r\n          </button>\r\n        </div>\r\n\r\n        <button \r\n          type=\"button\" \r\n          class=\"nav-button next\" \r\n          (click)=\"navigateNext()\"\r\n          [disabled]=\"disabled || !canNavigateToNextMonth() && currentView === 'day' || !canNavigateToNextYear() && currentView === 'month'\">\r\n          <svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\">\r\n            <polyline points=\"9,18 15,12 9,6\"></polyline>\r\n          </svg>\r\n        </button>\r\n      </div>\r\n\r\n      <!-- Action buttons (ocultos por defecto para dise\u00F1o m\u00E1s limpio) -->\r\n      <div class=\"calendar-actions\" *ngIf=\"mergedConfig.showTodayButton || mergedConfig.showClearButton\">\r\n        <button \r\n          *ngIf=\"mergedConfig.showTodayButton\"\r\n          type=\"button\" \r\n          class=\"action-button today-button\"\r\n          (click)=\"onTodayClick()\"\r\n          [disabled]=\"disabled\">\r\n          {{ mergedLocale.today }}\r\n        </button>\r\n        \r\n        <button \r\n          *ngIf=\"mergedConfig.showClearButton\"\r\n          type=\"button\" \r\n          class=\"action-button clear-button\"\r\n          (click)=\"onClearClick()\"\r\n          [disabled]=\"disabled\">\r\n          {{ mergedLocale.clear }}\r\n        </button>\r\n      </div>\r\n    </div>\r\n\r\n    <!-- Calendar content -->\r\n    <div class=\"calendar-content\">\r\n      <!-- Day view -->\r\n      <div class=\"calendar-days\" *ngIf=\"currentView === 'day'\">\r\n        <!-- Weekday headers -->\r\n        <div class=\"weekdays\">\r\n          <div \r\n            class=\"weekday-header\" \r\n            *ngFor=\"let weekday of getWeekdays()\">\r\n            {{ weekday }}\r\n          </div>\r\n        </div>\r\n\r\n        <!-- Calendar grid -->\r\n        <div class=\"days-grid\">\r\n          <div \r\n            class=\"week-row\" \r\n            *ngFor=\"let week of calendarDays\">\r\n            <div \r\n              class=\"day-cell\"\r\n              *ngFor=\"let day of week\"\r\n              [class.today]=\"day.isToday && mergedConfig.highlightToday\"\r\n              [class.selected]=\"day.isSelected\"\r\n              [class.disabled]=\"day.isDisabled\"\r\n              [class.other-month]=\"!day.isInCurrentMonth\"\r\n              [class.weekend]=\"day.isWeekend && mergedConfig.highlightWeekends\"\r\n              [class.has-event]=\"day.hasEvent\"\r\n              (click)=\"onDayClick(day)\">\r\n              <span class=\"day-number\">{{ day.day }}</span>\r\n              <div *ngIf=\"day.hasEvent\" class=\"event-indicator\"></div>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n\r\n      <!-- Month view -->\r\n      <div class=\"calendar-months\" *ngIf=\"currentView === 'month'\">\r\n        <div class=\"months-grid\">\r\n          <div \r\n            class=\"month-cell\"\r\n            *ngFor=\"let month of calendarMonths\"\r\n            [class.selected]=\"month.isSelected\"\r\n            [class.disabled]=\"month.isDisabled\"\r\n            [class.current]=\"month.isCurrent\"\r\n            (click)=\"onMonthClick(month)\">\r\n            {{ month.name }}\r\n          </div>\r\n        </div>\r\n      </div>\r\n\r\n      <!-- Year view -->\r\n      <div class=\"calendar-years\" *ngIf=\"currentView === 'year'\">\r\n        <div class=\"years-grid\">\r\n          <div \r\n            class=\"year-cell\"\r\n            *ngFor=\"let year of calendarYears\"\r\n            [class.selected]=\"year.isSelected\"\r\n            [class.disabled]=\"year.isDisabled\"\r\n            [class.current]=\"year.isCurrent\"\r\n            (click)=\"onYearClick(year)\">\r\n            {{ year.year }}\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n", styles: ["@charset \"UTF-8\";@import\"https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:ital,wght@0,200..800;1,200..800&display=swap\";:root{--sanna-font-family: Plus Jakarta Sans, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif;--sanna-font-light: Plus Jakarta Sans, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif;--sanna-font-regular: Plus Jakarta Sans, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif;--sanna-font-medium: Plus Jakarta Sans, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif;--sanna-font-semibold: Plus Jakarta Sans, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif;--sanna-font-bold: Plus Jakarta Sans, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif}.sanna-component{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif!important;font-optical-sizing:auto;font-style:normal;font-weight:400!important}.sanna-font-light{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif!important;font-optical-sizing:auto;font-style:normal;font-weight:300!important}.sanna-font-regular{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif!important;font-optical-sizing:auto;font-style:normal;font-weight:400!important}.sanna-font-medium,.sanna-font-semibold{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif!important;font-optical-sizing:auto;font-style:normal;font-weight:500!important}.sanna-font-bold{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif!important;font-optical-sizing:auto;font-style:normal;font-weight:700!important}[class*=sa-],[class^=sanna-]{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif!important;font-optical-sizing:auto;font-style:normal;font-weight:400!important}:host{display:block;width:100%;font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif;box-sizing:border-box;--primary-color: #36AD55;--secondary-color: #6c757d;--success-color: #32A047;--error-color: #ef4444;--warning-color: #f59e0b;--info-color: #3b82f6;--light-color: #f8f9fa;--dark-color: #212529;--background-color: #ffffff;--surface-color: #f8f9fa;--on-primary-color: #ffffff;--on-surface-color: #212529;--border-color: #dee2e6;--disabled-color: #e9ecef;--hover-color: #e9ecef;--weekday-header-bg: #f8f9fa;--weekday-header-color: #212529;--transition-duration: .2s;--border-radius: .375rem;--box-shadow: 0 .125rem .25rem rgba(0, 0, 0, .075);--box-shadow-focus: 0 0 0 .2rem rgba(54, 173, 85, .25)}:host ::ng-deep *{box-sizing:border-box!important;overflow:visible!important;max-height:none!important;height:auto!important;min-height:auto!important}:host ::ng-deep .sa-calendar-container{position:relative!important;width:100%!important;height:auto!important;min-height:auto!important;max-height:none!important;overflow:visible!important;display:block!important}:host ::ng-deep .calendar-input-container{width:100%!important;margin-bottom:0!important;overflow:visible!important;height:auto!important;min-height:auto!important;max-height:none!important;display:block!important;position:relative!important}:host ::ng-deep .form-label{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif!important;color:var(--on-surface-color)!important;font-size:14px!important;font-weight:400!important;margin-bottom:2px!important;display:inline-block!important;overflow:visible!important;height:auto!important}:host ::ng-deep .form-label.label-sm{font-size:11px!important}:host ::ng-deep .form-label.label-md{font-size:14px!important}:host ::ng-deep .form-label.label-lg{font-size:16px!important}:host ::ng-deep .form-label.ghost-label{visibility:hidden}:host ::ng-deep .form-label.ghost-label:before{content:\"\\a0\"}:host ::ng-deep .position-relative{position:relative!important;overflow:visible!important;height:auto!important;width:100%!important}:host ::ng-deep .calendar-input{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif!important;display:block!important;width:100%!important;padding:.375rem 2.5rem .375rem .75rem!important;font-size:16px!important;font-weight:400!important;line-height:1.5!important;color:var(--on-surface-color)!important;background-color:var(--background-color)!important;border:1px solid var(--border-color)!important;border-radius:var(--border-radius)!important;cursor:pointer!important;overflow:visible!important;height:auto!important}:host ::ng-deep .calendar-input:focus{outline:none!important;box-shadow:inset 0 0 0 2px var(--primary-color)!important;border-color:transparent!important}:host ::ng-deep .calendar-input:disabled{background-color:#e9ecef!important;opacity:1!important;cursor:default!important}:host ::ng-deep .calendar-input.form-control-sm{padding:4.125px 8.25px!important;padding-right:2.25rem!important;font-size:11px!important}:host ::ng-deep .calendar-input.form-control-lg{padding:.5rem 3rem .5rem 1rem!important;font-size:20px!important}:host ::ng-deep .calendar-icon,:host ::ng-deep .clear-icon{position:absolute!important;top:50%!important;right:.75rem!important;transform:translateY(-50%)!important;z-index:10!important;cursor:pointer!important;overflow:visible!important}:host ::ng-deep .calendar-icon svg,:host ::ng-deep .clear-icon svg{width:16px!important;height:16px!important}:host ::ng-deep .calendar-popup{position:absolute!important;top:100%!important;left:0!important;z-index:9999!important;background:var(--background-color)!important;border:1px solid var(--border-color)!important;border-radius:8px!important;box-shadow:0 8px 24px #0000001f!important;margin-top:4px!important;width:220px!important;max-width:90vw!important;overflow:visible!important;max-height:none!important;height:auto!important;min-height:auto!important;display:block!important}:host ::ng-deep .calendar-popup.open{opacity:1!important;visibility:visible!important}:host ::ng-deep .calendar-popup *{overflow:visible!important;max-height:none!important;height:auto!important;min-height:auto!important}:host ::ng-deep .calendar-header{padding:1rem 1rem .5rem!important;border-bottom:1px solid var(--border-color)!important;background:var(--background-color)!important;border-radius:8px 8px 0 0!important;overflow:visible!important;height:auto!important}:host ::ng-deep .calendar-header *{overflow:visible!important;max-height:none!important;height:auto!important}:host ::ng-deep .calendar-navigation{display:flex!important;align-items:center!important;justify-content:space-between!important;margin-bottom:.5rem!important;overflow:visible!important}:host ::ng-deep .nav-button{display:flex!important;width:28px!important;height:28px!important;border:none!important;background:transparent!important;cursor:pointer!important;border-radius:6px!important}:host ::ng-deep .nav-button:hover{background:var(--hover-color)!important}:host ::ng-deep .header-title{font-size:12px!important;font-weight:500!important;cursor:pointer!important;padding:.25rem .75rem!important;border-radius:6px!important;background:none!important;border:none!important}:host ::ng-deep .header-title:hover{background:var(--hover-color)!important}:host ::ng-deep .calendar-content{padding:.5rem .75rem .75rem!important;overflow:visible!important;max-height:none!important;height:auto!important;min-height:auto!important}:host ::ng-deep .calendar-content *{overflow:visible!important;max-height:none!important;height:auto!important;min-height:auto!important}:host ::ng-deep .calendar-days{overflow:visible!important;height:auto!important}:host ::ng-deep .calendar-days .weekdays{display:grid!important;grid-template-columns:repeat(7,1fr)!important;margin-bottom:6px!important;background-color:#e2f3e6!important;border-radius:4px!important;padding:.375rem 0!important;overflow:visible!important;height:auto!important}:host ::ng-deep .calendar-days .weekday-header{text-align:center!important;font-size:10px!important;font-weight:800!important;text-transform:uppercase!important;overflow:visible!important}:host ::ng-deep .calendar-days .days-grid{overflow:visible!important;height:auto!important}:host ::ng-deep .calendar-days .days-grid .week-row{display:grid!important;grid-template-columns:repeat(7,1fr)!important;gap:2px!important;margin-bottom:2px!important;overflow:visible!important;height:auto!important}:host ::ng-deep .calendar-days .day-cell{display:flex!important;align-items:center!important;justify-content:center!important;min-height:26px!important;border-radius:4px!important;cursor:pointer!important;overflow:visible!important;height:auto!important}:host ::ng-deep .calendar-days .day-cell .day-number{font-size:11px!important;z-index:1!important}:host ::ng-deep .calendar-days .day-cell:hover:not(.disabled){background:var(--hover-color)!important}:host ::ng-deep .calendar-days .day-cell.today .day-number{color:var(--primary-color)!important;font-weight:600!important}:host ::ng-deep .calendar-days .day-cell.today:after{content:\"\"!important;position:absolute!important;bottom:2px!important;left:50%!important;transform:translate(-50%)!important;width:4px!important;height:4px!important;background-color:var(--primary-color)!important;border-radius:50%!important}:host ::ng-deep .calendar-days .day-cell.selected{background:var(--primary-color)!important;color:var(--on-primary-color)!important}:host ::ng-deep .calendar-days .day-cell.selected .day-number{color:var(--on-primary-color)!important;font-weight:500!important}:host ::ng-deep .calendar-days .day-cell.disabled{opacity:.4!important;cursor:not-allowed!important}:host ::ng-deep .calendar-months{overflow:visible!important;height:auto!important}:host ::ng-deep .calendar-months .months-grid{display:grid!important;grid-template-columns:repeat(3,1fr)!important;gap:8px!important;overflow:visible!important;height:auto!important}:host ::ng-deep .calendar-months .month-cell{display:flex!important;align-items:center!important;justify-content:center!important;min-height:40px!important;border-radius:var(--border-radius)!important;cursor:pointer!important;font-size:11px!important;overflow:visible!important;height:auto!important}:host ::ng-deep .calendar-months .month-cell:hover:not(.disabled):not(.current):not(.selected){background:var(--hover-color)!important}:host ::ng-deep .calendar-months .month-cell.current,:host ::ng-deep .calendar-months .month-cell.selected{background:var(--primary-color)!important;color:var(--on-primary-color)!important}:host ::ng-deep .calendar-years{overflow:visible!important;height:auto!important}:host ::ng-deep .calendar-years .years-grid{display:grid!important;grid-template-columns:repeat(4,1fr)!important;gap:8px!important;overflow:visible!important;height:auto!important}:host ::ng-deep .calendar-years .year-cell{display:flex!important;align-items:center!important;justify-content:center!important;min-height:40px!important;border-radius:var(--border-radius)!important;cursor:pointer!important;font-size:11px!important;overflow:visible!important;height:auto!important}:host ::ng-deep .calendar-years .year-cell:hover:not(.disabled):not(.current):not(.selected){background:var(--hover-color)!important}:host ::ng-deep .calendar-years .year-cell.current,:host ::ng-deep .calendar-years .year-cell.selected{background:var(--primary-color)!important;color:var(--on-primary-color)!important}:host ::ng-deep .form-text,:host ::ng-deep .invalid-feedback{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif!important;font-size:12px!important;margin-top:.25rem!important;overflow:visible!important}:host ::ng-deep .invalid-feedback{color:var(--error-color)!important}@media (max-width: 576px){:host ::ng-deep .calendar-popup{left:50%!important;transform:translate(-50%)!important;width:200px!important;max-width:calc(100vw - 2rem)!important;overflow:visible!important}:host ::ng-deep .day-cell{min-height:24px!important}:host ::ng-deep .day-cell .day-number{font-size:10px!important}:host ::ng-deep .months-grid{grid-template-columns:repeat(2,1fr)!important}:host ::ng-deep .years-grid{grid-template-columns:repeat(3,1fr)!important}}:host ::ng-deep .size-sm .calendar-popup{min-width:240px!important}:host ::ng-deep .size-sm .day-cell{min-height:28px!important}:host ::ng-deep .size-sm .month-cell,:host ::ng-deep .size-sm .year-cell{min-height:32px!important;font-size:10px!important}:host ::ng-deep .size-lg .calendar-popup{min-width:320px!important}:host ::ng-deep .size-lg .day-cell{min-height:44px!important}:host ::ng-deep .size-lg .month-cell,:host ::ng-deep .size-lg .year-cell{min-height:56px!important;font-size:16px!important}:host ::ng-deep *::-webkit-scrollbar{display:none!important;width:0!important;height:0!important}:host{position:relative!important;z-index:1!important;overflow:visible!important;max-height:none!important;height:auto!important;min-height:auto!important}:host(.theme-dark){--background-color: #1f2937;--surface-color: #374151;--on-surface-color: #f9fafb;--border-color: #4b5563;--disabled-color: #374151;--hover-color: #4b5563;--secondary-color: #9ca3af}:host(.theme-compact) ::ng-deep .day-cell{min-height:28px!important}:host(.theme-compact) ::ng-deep .calendar-header{padding:.5rem!important}:host(.theme-compact) ::ng-deep .calendar-content{padding:.5rem!important}@keyframes fadeInUp{0%{opacity:0;transform:translateY(10px)}to{opacity:1;transform:translateY(0)}}:host ::ng-deep .calendar-popup.open{animation:fadeInUp var(--transition-duration) ease-out!important}\n"], dependencies: [{ kind: "directive", type: i1.NgForOf, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { kind: "directive", type: i1.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.ShadowDom });
}

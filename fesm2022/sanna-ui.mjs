...
class SaCalendarComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "18.2.13", type: SaCalendarComponent, selector: "sa-calendar", inputs: { size: "size", status: "status", label: "label", noLabel: "noLabel", hideLabel: "hideLabel", placeholder: "placeholder", helperText: "helperText", errorText: "errorText", required: "required", readonly: "readonly", disabled: "disabled", minDate: "minDate", maxDate: "maxDate", id: "id", name: "name", class: "class", locale: "locale", colors: "colors", config: "config", validation: "validation", events: "events", inline: "inline", showInput: "showInput" }, outputs: { dateSelect: "dateSelect", viewChange: "viewChange", monthChange: "monthChange", yearChange: "yearChange", focus: "focus", blur: "blur", change: "change", valueChange: "valueChange" }, host: { listeners: { "document:click": "onDocumentClickOutside($event)" }, properties: { "class.sanna-ui-calendar-size-sm": "size === \"sm\"", "class.sanna-ui-calendar-size-md": "size === \"md\"", "class.sanna-ui-calendar-size-lg": "size === \"lg\"", "class.sanna-ui-calendar-disabled": "disabled", "class.sanna-ui-calendar-readonly": "readonly", "class.sanna-ui-calendar-inline": "inline", "class": "this.hostClasses" }, classAttribute: "sanna-ui-component sanna-ui-calendar" }, providers: [
            {
                provide: NG_VALUE_ACCESSOR,

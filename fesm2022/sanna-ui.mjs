...
class SaInputComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "18.2.13", type: SaInputComponent, selector: "sa-input", inputs: { value: "value", type: "type", placeholder: "placeholder", size: "size", status: "status", label: "label", helperText: "helperText", errorText: "errorText", leftIcon: "leftIcon", rightIcon: "rightIcon", required: "required", readonly: "readonly", disabled: "disabled", id: "id", name: "name", autocomplete: "autocomplete", min: "min", max: "max", minlength: "minlength", maxlength: "maxlength", pattern: "pattern", backgroundColor: "backgroundColor", textColor: "textColor" }, outputs: { valueChange: "valueChange", focus: "focus", blur: "blur" }, host: { classAttribute: "sa-ui-scope" }, providers: [
            {
                provide: NG_VALUE_ACCESSOR,
                useExisting: forwardRef(() => SaInputComponent),
                multi: true
            }
        ], ngImport: i0, template: "<div class=\"\">\n  <label *ngIf=\"label\" [for]=\"id\" [class]=\"labelClasses\">\n    {{ label }}\n    <span *ngIf=\"required\" class=\"text-danger\">*</span>\n  </label>\n\n  <div [class]=\"inputGroupClasses\">\n    <span *ngIf=\"leftIcon\" class=\"input-group-text\">\n      <sa-icon \n        *ngIf=\"!leftIcon.includes('fa-')\" \n        [name]=\"leftIcon\" \n        size=\"sm\">\n      </sa-icon>\n      <i \n        *ngIf=\"leftIcon.includes('fa-')\" \n        [class]=\"leftIcon\">\n      </i>\n    </span>\n\n    <input\n      [id]=\"id\"\n      [name]=\"name\"\n      [type]=\"inputType\"\n      [class]=\"inputClasses\"\n      [ngStyle]=\"inputStyles\"\n      [(ngModel)]=\"value\"\n      (ngModelChange)=\"onModelChange($event)\"\n      [placeholder]=\"placeholder\"\n      [required]=\"required\"\n      [readonly]=\"readonly\"\n      [disabled]=\"disabled\"\n      [autocomplete]=\"autocomplete\"\n      [min]=\"min\"\n      [max]=\"max\"\n      [minlength]=\"minlength\"\n      [maxlength]=\"maxlength\"\n      [pattern]=\"pattern\"\n      spellcheck=\"false\"\n      autocorrect=\"off\"\n      autocapitalize=\"off\"\n      data-gramm=\"false\"\n      data-gramm_editor=\"false\"\n      data-enable-grammarly=\"false\"\n      (focus)=\"onInputFocus($event)\"\n      (blur)=\"onInputBlur($event)\"\n    />\n\n    <span *ngIf=\"rightIcon && type !== 'password'\" class=\"input-group-text\">\n      <sa-icon \n        *ngIf=\"!rightIcon.includes('fa-')\" \n        [name]=\"rightIcon\" \n        size=\"sm\">\n      </sa-icon>\n      <i \n        *ngIf=\"rightIcon.includes('fa-')\" \n        [class]=\"rightIcon\">\n      </i>\n    </span>\n\n    <button\n      *ngIf=\"type === 'password'\"\n      type=\"button\"\n      class=\"btn btn-outline-secondary\"\n      (click)=\"togglePasswordVisibility()\"\n      [attr.aria-label]=\"showPassword ? 'Ocultar contrase\u00F1a' : 'Mostrar contrase\u00F1a'\"\n    >\n      <sa-icon \n        [name]=\"showPassword ? 'eye-slash' : 'eye'\" \n        size=\"sm\">\n      </sa-icon>\n    </button>\n  </div>\n\n  <div *ngIf=\"helperText && !errorText\" [class]=\"helperTextClasses\">{{ helperText }}</div>\n  <div *ngIf=\"errorText\" [class]=\"errorTextClasses\">{{ errorText }}</div>\n</div>", styles: ["@charset \"UTF-8\";@import\"https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:ital,wght@0,200..800;1,200..800&display=swap\";:root{--sanna-font-family: Plus Jakarta Sans, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif;--sanna-font-light: Plus Jakarta Sans, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif;--sanna-font-regular: Plus Jakarta Sans, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif;--sanna-font-medium: Plus Jakarta Sans, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif;--sanna-font-semibold: Plus Jakarta Sans, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif;--sanna-font-bold: Plus Jakarta Sans, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif}.sanna-component{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif!important;font-optical-sizing:auto;font-style:normal;font-weight:400!important}.sanna-font-light{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif!important;font-optical-sizing:auto;font-style:normal;font-weight:300!important}.sanna-font-regular{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif!important;font-optical-sizing:auto;font-style:normal;font-weight:400!important}.sanna-font-medium,.sanna-font-semibold{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif!important;font-optical-sizing:auto;font-style:normal;font-weight:500!important}.sanna-font-bold{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif!important;font-optical-sizing:auto;font-style:normal;font-weight:700!important}[class*=sa-],[class^=sanna-]{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif!important;font-optical-sizing:auto;font-style:normal;font-weight:400!important}.sa-ui-scope{display:block;width:100%;box-sizing:border-box;font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif}.sa-ui-scope .form-label{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif;color:#212529;font-size:14px;font-weight:400!important;margin-bottom:2px;display:inline-block}.sa-ui-scope .form-label.label-sm{font-size:11px!important}.sa-ui-scope .form-label.label-md{font-size:14px!important}.sa-ui-scope .form-label.label-lg{font-size:16px!important}.sa-ui-scope .form-control{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif;display:block;width:100%;padding:.375rem .75rem;font-size:1rem;font-weight:400;line-height:1.5;color:#212529;background-color:#fff;background-clip:padding-box;border:1px solid #dee2e6!important;border-radius:.375rem!important;transition:border-color .15s ease-in-out,box-shadow .15s ease-in-out!important;box-sizing:border-box;outline:0;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;text-decoration:none!important;text-decoration-line:none!important;text-decoration-style:none!important;text-decoration-color:transparent!important}.sa-ui-scope .form-control::-webkit-grammar-error-underline{display:none!important;text-decoration:none!important;background:none!important}.sa-ui-scope .form-control::-webkit-spell-check-decoration{display:none!important;text-decoration:none!important;background:none!important}.sa-ui-scope .form-control::-moz-spell-check{display:none!important;text-decoration:none!important;background:none!important}.sa-ui-scope .form-control::part(input){text-decoration:none!important;background-image:none!important}.sa-ui-scope .form-control:focus{outline:none!important;box-shadow:inset 0 0 0 2px #36ad55!important;border-color:transparent!important}.sa-ui-scope .form-control:disabled{background-color:#e9ecef;opacity:1}.sa-ui-scope .form-control:read-only{background-color:#e9ecef}.sa-ui-scope .form-control.is-valid{border-color:#10b981}.sa-ui-scope .form-control.is-valid:focus{outline:none!important;box-shadow:inset 0 0 0 2px #10b981!important;border-color:transparent!important}.sa-ui-scope .form-control.is-invalid{border-color:#ef4444}.sa-ui-scope .form-control.is-invalid:focus{outline:none!important;box-shadow:inset 0 0 0 2px #ef4444!important;border-color:transparent!important}.sa-ui-scope .form-control.form-control-sm{min-height:calc(1.5em + .5rem + 2px);padding:4.125px 8.25px!important;font-size:11px!important;border-radius:.25rem}.sa-ui-scope .form-control.form-control-lg{min-height:calc(1.5em + 1rem + 2px);padding:.5rem 1rem;font-size:1.25rem;border-radius:.5rem}.sa-ui-scope .input-group{position:relative;display:flex;flex-wrap:wrap;align-items:stretch;width:100%}.sa-ui-scope .input-group>.form-control{position:relative;flex:1 1 auto;width:1%;min-width:0;margin-bottom:0}.sa-ui-scope .input-group>.form-control:not(:first-child){border-top-left-radius:0;border-bottom-left-radius:0}.sa-ui-scope .input-group>.form-control:not(:last-child){border-top-right-radius:0;border-bottom-right-radius:0}.sa-ui-scope .input-group.input-group-sm>.form-control,.sa-ui-scope .input-group.input-group-sm>.input-group-text{min-height:calc(1.5em + .5rem + 2px);padding:.25rem .5rem;font-size:.875rem;border-radius:.25rem}.sa-ui-scope .input-group.input-group-lg>.form-control,.sa-ui-scope .input-group.input-group-lg>.input-group-text{min-height:calc(1.5em + 1rem + 2px);padding:.5rem 1rem;font-size:1.25rem;border-radius:.5rem}.sa-ui-scope .input-group-text{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif;display:flex;align-items:center;justify-content:center;padding:.375rem .75rem;font-size:1rem;font-weight:400;line-height:1.5;color:#6c757d;text-align:center;white-space:nowrap;background-color:#f8f9fa!important;border:1px solid #dee2e6!important;box-sizing:border-box;margin-bottom:0}.sa-ui-scope .input-group-text:first-child{border-top-right-radius:0;border-bottom-right-radius:0}.sa-ui-scope .input-group-text:last-child{border-top-left-radius:0;border-bottom-left-radius:0}.input-group-sm .sa-ui-scope .input-group-text{padding:.25rem .5rem;font-size:.875rem}.input-group-lg .sa-ui-scope .input-group-text{padding:.5rem 1rem;font-size:1.25rem}.sa-ui-scope .btn-outline-secondary{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif;display:flex;align-items:center;justify-content:center;font-weight:400;line-height:1.5;color:#6c757d;text-align:center;text-decoration:none;vertical-align:middle;cursor:pointer;-webkit-user-select:none;user-select:none;background-color:transparent!important;border:1px solid #dee2e6!important;padding:.375rem .75rem;font-size:1rem;border-radius:.375rem;transition:color .15s ease-in-out,background-color .15s ease-in-out,border-color .15s ease-in-out,box-shadow .15s ease-in-out;box-sizing:border-box;margin-bottom:0}.input-group .sa-ui-scope .btn-outline-secondary:not(:first-child){border-top-left-radius:0;border-bottom-left-radius:0}.sa-ui-scope .btn-outline-secondary:hover{background-color:#f8f9fa;border-color:#dee2e6;color:#495057}.sa-ui-scope .btn-outline-secondary:focus{outline:none!important;box-shadow:none!important;border-color:#dee2e6!important}.sa-ui-scope .btn-outline-secondary:disabled{opacity:.65;cursor:not-allowed}.input-group-sm .sa-ui-scope .btn-outline-secondary{padding:.25rem .5rem;font-size:.875rem}.input-group-lg .sa-ui-scope .btn-outline-secondary{padding:.5rem 1rem;font-size:1.25rem}.sa-ui-scope .form-text{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif;font-size:12px;color:#6b7280;margin-top:2px}.sa-ui-scope .form-text.helper-text-sm,.sa-ui-scope .form-text.helper-text-md{font-size:12px}.sa-ui-scope .form-text.helper-text-lg{font-size:14px}.sa-ui-scope .invalid-feedback{font-family:Plus Jakarta Sans,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif;font-size:12px;margin-top:2px;color:#dc3545;display:block}.sa-ui-scope .invalid-feedback.error-text-sm,.sa-ui-scope .invalid-feedback.error-text-md{font-size:12px}.sa-ui-scope .invalid-feedback.error-text-lg{font-size:14px}.sa-ui-scope .text-danger{color:#dc3545!important}.sa-ui-scope :last-child{margin-bottom:0!important}.sa-ui-scope i{font-style:normal;display:inline-block;width:1em;height:1em;vertical-align:middle}.sa-ui-scope sa-icon{display:inline-block!important;vertical-align:middle;line-height:1}.sa-ui-scope sa-icon fa-icon{display:inline-block!important;vertical-align:middle;line-height:1}.sa-ui-scope sa-icon svg{display:inline-block;font-size:inherit;height:1em;width:1em;overflow:visible;vertical-align:-.125em}.sa-ui-scope sa-icon[size=sm]{font-size:.875rem}.sa-ui-scope sa-icon[size=sm] svg{height:.875em;width:.875em}.sa-ui-scope sa-icon[size=md]{font-size:1rem}.sa-ui-scope sa-icon[size=md] svg{height:1em;width:1em}.sa-ui-scope sa-icon[size=lg]{font-size:1.25rem}.sa-ui-scope sa-icon[size=lg] svg{height:1.25em;width:1.25em}.sa-ui-scope .input-group-text i,.sa-ui-scope .input-group-text sa-icon{display:flex;align-items:center;justify-content:center;width:1em;height:1em}.sa-ui-scope .input-group-text i fa-icon,.sa-ui-scope .input-group-text sa-icon fa-icon{display:flex!important;align-items:center;justify-content:center}.sa-ui-scope .input-group-text i svg,.sa-ui-scope .input-group-text sa-icon svg{width:1em;height:1em}.sa-ui-scope .input-group-sm .input-group-text sa-icon{font-size:.875rem}.sa-ui-scope .input-group-sm .input-group-text sa-icon svg{width:.875em;height:.875em}.sa-ui-scope .input-group-lg .input-group-text sa-icon{font-size:1.25rem}.sa-ui-scope .input-group-lg .input-group-text sa-icon svg{width:1.25em;height:1.25em}.sa-ui-scope .btn sa-icon{display:flex!important;align-items:center;justify-content:center}.sa-ui-scope .btn sa-icon fa-icon{display:flex!important;align-items:center;justify-content:center}.sa-ui-scope .btn sa-icon svg{display:block;margin:0 auto}.sa-ui-scope .input-group-sm .btn sa-icon{font-size:.875rem}.sa-ui-scope .input-group-sm .btn sa-icon svg{width:.875em;height:.875em}.sa-ui-scope .input-group-lg .btn sa-icon{font-size:1.25rem}.sa-ui-scope .input-group-lg .btn sa-icon svg{width:1.25em;height:1.25em}.sa-ui-scope .input-group .btn-outline-secondary{min-height:calc(1.5em + .75rem + 2px);display:flex!important;align-items:center;justify-content:center}.sa-ui-scope .input-group .btn-outline-secondary sa-icon{display:flex!important;align-items:center;justify-content:center;line-height:1}.sa-ui-scope .input-group .btn-outline-secondary sa-icon fa-icon{display:flex!important;align-items:center;justify-content:center;line-height:1}.sa-ui-scope .input-group .btn-outline-secondary sa-icon svg{display:block}.sa-ui-scope .input-group-sm .btn-outline-secondary{min-height:calc(1.5em + .5rem + 2px)}.sa-ui-scope .input-group-sm .btn-outline-secondary sa-icon{font-size:.875rem}.sa-ui-scope .input-group-sm .btn-outline-secondary sa-icon svg{width:.875em;height:.875em}.sa-ui-scope .input-group-lg .btn-outline-secondary{min-height:calc(1.5em + 1rem + 2px)}.sa-ui-scope .input-group-lg .btn-outline-secondary sa-icon{font-size:1.25rem}.sa-ui-scope .input-group-lg .btn-outline-secondary sa-icon svg{width:1.25em;height:1.25em}.sa-ui-scope fa-icon{display:inline-block!important;font-size:inherit;height:1em;overflow:visible;vertical-align:-.125em}.sa-ui-scope .input-group-text:empty:before,.sa-ui-scope .btn:empty:before{content:\"\\25ef\";color:#6c757d;font-size:inherit;display:inline-block;vertical-align:middle}.sa-ui-scope .input-group-text:not(:empty):before,.sa-ui-scope .btn:not(:empty):before{display:none}\n"], dependencies: [{ kind: "directive", type: i1.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "directive", type: i1.NgStyle, selector: "[ngStyle]", inputs: ["ngStyle"] }, { kind: "directive", type: i2$1.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { kind: "directive", type: i2$1.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { kind: "directive", type: i2$1.RequiredValidator, selector: ":not([type=checkbox])[required][formControlName],:not([type=checkbox])[required][formControl],:not([type=checkbox])[required][ngModel]", inputs: ["required"] }, { kind: "directive", type: i2$1.MinLengthValidator, selector: "[minlength][formControlName],[minlength][formControl],[minlength][ngModel]", inputs: ["minlength"] }, { kind: "directive", type: i2$1.MaxLengthValidator, selector: "[maxlength][formControlName],[maxlength][formControl],[maxlength][ngModel]", inputs: ["maxlength"] }, { kind: "directive", type: i2$1.PatternValidator, selector: "[pattern][formControlName],[pattern][formControl],[pattern][ngModel]", inputs: ["pattern"] }, { kind: "directive", type: i2$1.NgModel, selector: "[ngModel]:not([formControlName]):not([formControl])", inputs: ["name", "disabled", "ngModel", "ngModelOptions"], outputs: ["ngModelChange"], exportAs: ["ngModel"] }, { kind: "component", type: SaIconComponent, selector: "sa-icon", inputs: ["name", "color", "size"] }], encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.13", ngImport: i0, type: SaInputComponent, decorators: [{
            type: Component,
            args: [{ selector: 'sa-input', encapsulation: ViewEncapsulation.None, host: {
                        'class': 'sa-ui-scope'
                    }, providers: [
                        {
                            provide: NG_VALUE_ACCESSOR,

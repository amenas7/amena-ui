...
export declare class SaLegendComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<SaLegendComponent, "sa-legend", never, { "color": { "alias": "color"; "required": false; }; "tooltip": { "alias": "tooltip"; "required": false; }; "tooltipPosition": { "alias": "tooltipPosition"; "required": false; }; }, {}, never, never, false, never>;
}

...
<Meta title="Componentes/Forms/Calendar/Calendar Example" />

# 📚 Code Example - sa-calendar
    ...
    <div class="row g-3">
      <div class="col-md-6">
        <sa-calendar
          ...
          placeholder="Desde mañana"
          [minDate]="tomorrow"
          helperText="Solo fechas a partir de mañana">
        </sa-calendar>
      </div>
      <div class="col-md-6">
        <sa-calendar
      ...
      <div class="col-md-6">
        <sa-calendar
          ...
          helperText="Solo próximos 30 días">
        </sa-calendar>
      </div>
    </div>
  </div>
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <sa-calendar
                ...
                helperText="Este calendario tiene todas las propiedades configuradas con status dinámico"

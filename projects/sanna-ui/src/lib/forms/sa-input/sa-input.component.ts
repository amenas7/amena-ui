import { Component, Input, Output, EventEmitter, forwardRef, ViewEncapsulation, ViewChild, ElementRef, HostBinding, OnChanges, SimpleChanges, ChangeDetectorRef } from '@angular/core';
